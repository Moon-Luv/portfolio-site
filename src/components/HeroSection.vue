  ...
  >
    <div class="container mx-auto">
      <div class="flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-12">
        <!-- Left side with text -->
        <div v-motion="heroAnimation" class="w-full lg:w-1/2 space-y-6">
          ...
          <div class="h-16 flex items-center">
            <p class="text-xl md:text-2xl lg:text-3xl font-medium text-gray-700 dark:text-gray-300 flex flex-wrap">
              I'm a 
          ...
          <div class="pt-4 flex flex-wrap gap-4">
            <a 
              href="#contact" 
              class="inline-block px-6 sm:px-8 py-3 bg-primary-600 hover:bg-primary-700 text-white font-medium rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1"
            ...
            <a 
              href="#projects" 
              class="inline-block px-6 sm:px-8 py-3 bg-transparent border-2 border-primary-600 dark:border-primary-400 text-primary-600 dark:text-primary-400 font-medium rounded-lg hover:bg-primary-600/10 transition-colors duration-300"
        ...
        <div v-motion="heroAnimation" class="w-full lg:w-1/2 flex justify-center mt-8 lg:mt-0">
