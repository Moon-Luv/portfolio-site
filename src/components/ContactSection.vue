      ...
      <div class="flex flex-col md:flex-row gap-12">
        ...
        <div v-motion="contactAnimation" class="w-full md:w-1/2 space-y-6">
          ...
          <form @submit="handleSubmit" class="space-y-4">
            ...
            <div v-if="status" class="p-4 rounded-lg" :class="status.includes('Thanks') ? 'bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-400' : 'bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-400'">
              {{ status }}
            </div>
          </form>
        </div>
        ...
        <div v-motion="contactAnimation" class="w-full md:w-1/2 space-y-6">
          ...
          <p class="text-gray-600 dark:text-gray-300">
            Feel free to reach out to me through the contact form or via any of the social media platforms below. I'm always open to discussing new projects, creative ideas, or opportunities to be part of your vision.
          </p>
