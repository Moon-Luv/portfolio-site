...
// Social media links - same as in ContactSection
const socialLinks = [
  {
    name: 'GitHub',
  ...
  {
    name: 'Twitter',
    url: 'https://x.com/PolashPramanik9',
...
<template>
  <footer class="bg-gray-100 dark:bg-dark-800 py-8">
    <div class="container mx-auto px-4">
      <div class="flex flex-col md:flex-row justify-between items-center">
        <!-- Copyright -->
        <div class="text-gray-600 dark:text-gray-400 mb-4 md:mb-0">
          &copy; {{ currentYear }} Polash Pramanik. All rights reserved.
        </div>
